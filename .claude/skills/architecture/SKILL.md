...
### 1. Read Feature Spec
- Read the spec from `features/<tab>/<slug>.md` (e.g. `features/repricer/dashboard.md`)
...
Add a "Tech Design (Solution Architect)" section to the feature spec file (`features/<tab>/<slug>.md`)
...
## Git Commit
```
docs(area/slug): Add technical design for [feature name]
```
Example: `docs(repricer/dashboard): Add technical design`
