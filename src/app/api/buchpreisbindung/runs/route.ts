...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase
      ...
      .select('id, seller_id, amazon_seller_id, status, triggered_by, total_items, violations_count, excel_file_path, error_message, started_at, completed_at, created_at')
