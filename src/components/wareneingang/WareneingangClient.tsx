...
import {
  Package, Truck, CheckCircle2, FileText, Loader2, RefreshCw, PackageCheck, AlertTriangle,
} from 'lucide-react'
        ...
        <Card>
          <CardContent className="py-12 text-center text-muted-foreground">
            ...
            <p className="text-xs mt-1">
              Auftragsbestätigungen und Lieferscheine erscheinen automatisch, sobald sie per Mail eingehen.
            </p>
          </CardContent>
        </Card>
      ) : (
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-foreground">
                          {SUPPLIER_LABEL[row.supplier] ?? row.supplier}
                        </span>
                      </div>
                      ...
                      {row.status === 'empfangen' && (
                        <div className="flex flex-wrap gap-x-5 gap-y-1 pt-1 text-xs text-muted-foreground">
                          ...
                          {row.paletten_geprueft != null && (
                            <span>Geprüft: <span className="text-foreground">{row.paletten_geprueft} Paletten</span></span>
                          )}
                          {row.schaden && (
