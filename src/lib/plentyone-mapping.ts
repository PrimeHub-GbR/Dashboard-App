...
export const MAPPING_SPALTEN: MappingZeile[] = [
  ...
  A('aktiv', 'Varianten » Aktiv', 'Amazon-Status: 1 = „Active“, 0 = „Inactive“. Der Fehler vom 04.09.2026 (kam durchgehend als 0 an, Varianten wurden inaktiv angelegt, Market-Listing-Prüfung schlug fehl) ist am 07.09.2026 geklärt: Der Bericht „zu aktiven Angeboten“ hat gar keine status-Spalte — anders als „zu allen Angeboten“. Die Prüfung lief ins Leere. Der Generator wertet eine fehlende Spalte jetzt als aktiv, weil dieser Bericht per Definition nur aktive Angebote enthält.'),
  A('verfuegbarkeit', 'Varianten » Verfügbarkeit', 'Immer 1. Diente als Behelfsquelle für „Varianten » Aktiv“, solange Spalte 4 durchgehend 0 lieferte — seit der Generator-Härtung vom 07.09.2026 nicht mehr nötig, schadet aber nicht.', 'fest'),
  ...
  A('mandant_aktiv', null, 'Immer 1. NICHT zuordnen — es gibt keinen PlentyONE-Shop, nur Marktplätze. Belegt an Variante 1175: Mandant (Shop) steht auf AUS und das eBay-Listing funktioniert trotzdem.', 'fest'),
