...
export const MAPPING_SPALTEN: MappingZeile[] = [
  ...
  A('marktplatz_id', 'SKU » Marktplatz-ID', '104 = „Amazon FBA“ (der generische Kanal). NICHT 104.01 und nicht 4.01 — Länderebenen legen stillschweigend gar keine SKU an. **104 trägt beides**: den FBA-Bestandsabgleich und die Versandfreigabe per Multi-Channel. Der Kanal 4 („Amazon“) kann nur den Bestand — mit ihm scheitert jeder MCF-Auftrag an „sellerSku must be of type string, null given“. Belegt am 09.09.2026 an Variante 1208: SKU 4 gelöscht, Bestand auf 0 gesetzt, manueller Abgleich — der Bestand kam allein über die 104er-SKU zurück.', 'fest'),
