...
export const MAPPING_SPALTEN: MappingZeile[] = [
  ...
  A('aktiv', 'Varianten » Aktiv', 'Amazon-Status: 1 = „Active", 0 = „Inactive". ACHTUNG: kam am 04.09.2026 durchgehend als 0 an — die Varianten wurden dadurch inaktiv angelegt und die Market-Listing-Prüfung schlug fehl. Bis das geklärt ist, wird dieses Zielfeld aus „verfuegbarkeit" (konstant 1) befüllt. Zulässig, weil nur der Bericht der aktiven Angebote hochgeladen wird.'),
  A('verfuegbarkeit', 'Varianten » Verfügbarkeit', 'Immer 1. Dient auch als Quelle für „Varianten » Aktiv" — siehe Spalte 4.', 'fest'),
