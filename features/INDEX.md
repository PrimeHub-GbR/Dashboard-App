...
| PROJ-4 | Login / Authentifizierung (Email + Passwort, Supabase Auth) | Planned | [PROJ-4-login.md](PROJ-4-login.md) | 2026-03-03 |
| PROJ-5 | Dashboard-Navigation (Sidebar Shell für alle Features) | Planned | [PROJ-5-dashboard-nav.md](PROJ-5-dashboard-nav.md) | 2026-03-03 |
