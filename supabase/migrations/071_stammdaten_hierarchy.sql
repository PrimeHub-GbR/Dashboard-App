-- Migration 071: Stammdaten-Aenderung folgt der Hierarchie.
-- Aendern darf nur, wer ein hoeheres Level hat als die Zielperson. Der Manager
-- kann also Mitarbeiter-Stammdaten aendern, aber NICHT die eigenen — das macht
-- die Geschaeftsfuehrung. GF-Ebene (Level 3) darf sich gegenseitig + selbst
-- verwalten (keine hoehere Instanz vorhanden).
